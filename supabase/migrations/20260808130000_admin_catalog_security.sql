-- A tabela products antecede o histórico de migrations: ela foi criada no
-- painel durante a primeira implantação. Mantê-la aqui torna uma instalação
-- limpa reproduzível sem alterar projetos nos quais a tabela já existe.
