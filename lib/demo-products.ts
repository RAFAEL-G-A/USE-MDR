...
export const demoProducts: DemoProduct[] = [
  ...
  { id: "demo-blush", name: "Blush Rosé Cloud", category: "Paletas", subcategory: "Blush", price: 39.9, image: blushImage, description: "Blush de toque macio e cor construível para um efeito saudável e sofisticado.", stock: 15 },
