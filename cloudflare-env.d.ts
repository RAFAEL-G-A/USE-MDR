/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 802d2d2eae1356b1b82893adc43a13a0)
// Runtime types generated with workerd@1.20260811.1 2026-08-13 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	SUPABASE_URL: "https://tsrsncnraamnhcfyyxlg.supabase.co";
	NEXT_PUBLIC_SUPABASE_URL: string;
	NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY: string;
	NEXT_PUBLIC_WHATSAPP_NUMBER: string;
	WORKER_SELF_REFERENCE: Fetcher /* use-mdr-beauty-preview */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_URL" | "NEXT_PUBLIC_SUPABASE_URL" | "NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY" | "NEXT_PUBLIC_WHATSAPP_NUMBER">> {}
}
