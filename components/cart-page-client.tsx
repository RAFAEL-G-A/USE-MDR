...
import { trackStoreEvent } from "@/components/store-analytics-tracker";
  ...
  return (
    <div className="min-h-screen pb-28 md:pb-0">
      ...
      <main className="mx-auto max-w-5xl px-5 py-9 md:px-8 md:py-14">
        ...
        {items.length === 0 ? (
          <section className="mt-10 rounded-[2rem] border border-dashed border-brand-border bg-brand-soft/40 px-6 py-16 text-center"><p className="font-serif text-3xl">Seu carrinho está vazio</p><p className="mx-auto mt-3 max-w-sm text-sm leading-6 text-muted">Explore o catálogo e adicione os produtos que deseja pedir pelo WhatsApp.</p><Link href="/catalogo#produtos" prefetch={false} className="mt-7 inline-flex min-h-12 items-center rounded-full bg-brand px-6 text-xs font-extrabold text-white">EXPLORAR PRODUTOS</Link></section>
        ) : (
