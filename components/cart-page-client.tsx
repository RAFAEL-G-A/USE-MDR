...
export function CartPageClient() {
  ...
  return (
    <div className="min-h-screen pb-28 md:pb-0">
      <header className="border-b border-white/10 bg-[linear-gradient(135deg,#4a1728_0%,#76213e_52%,#a62f59_100%)] text-white"><div className="mx-auto flex min-h-24 max-w-7xl items-center justify-center px-5 md:min-h-28 md:justify-between md:px-8"><Brand /><nav className="hidden items-center gap-8 text-sm font-semibold text-white/80 md:flex"><Link href="/">Início</Link><Link href="/catalogo">Buscar</Link><Link href="/favoritos">Favoritos</Link><Link href="/carrinho" className="text-[#ffabc5]">Carrinho</Link></nav></div></header>
