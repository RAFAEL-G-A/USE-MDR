  ...
  return (
    <div className="min-h-screen pb-28 md:pb-0">
      ...
      <main className="mx-auto max-w-7xl px-5 py-8 md:px-8 md:py-12">
        ...
        <form action="/catalogo#produtos" method="get" className="relative mt-7 max-w-2xl">
